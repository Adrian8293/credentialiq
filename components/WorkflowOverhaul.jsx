...
export function WorkflowProviderCard({ prov, db, onOpen, onEdit, onEnroll, onTask }) {
  const score = providerReadiness(prov)
  const licD = daysUntilWF(prov.licenseExp)
  const malD = daysUntilWF(prov.malExp)
  const caqhD = daysUntilWF(prov.caqhDue)
...
export function ProviderCommandCenter({ prov, db, onClose, onEdit, openEnrollModal, toast }) {
