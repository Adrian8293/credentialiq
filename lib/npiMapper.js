...
export function diffNpiVsProvider(npiCard, provider) {
  ...
  const COMPARE_FIELDS = [
    ...
    // NOTE: 'spec' intentionally excluded — that is CredFlow's internal
    // specialty category (Mental Health, Massage Therapy, etc.) and should
    // never be overwritten by NPPES taxonomy descriptions.
    // 'taxonomyDesc' is surfaced as read-only info in the sync modal instead.
  ]
